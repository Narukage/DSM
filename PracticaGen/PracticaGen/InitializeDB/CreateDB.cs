...
public static void InitializeData ()
{
        ...
        try
        {
                ...
                int a = hola.New_ (3.0, "FFF", "FFF", 1, 1);
                IList<int> cosas = new List<int>();
                cosas.Add (idg);
                hola.AnaydirIngrediente (a, cosas);
                IList<int> cosas2 = new List<int>();
                cosas2.Add(idg2);
               hola.AnaydirIngrediente(a, cosas2);
               Console.WriteLine (hola.ReadOID(a).Ingrediente.Count); //preguntar
